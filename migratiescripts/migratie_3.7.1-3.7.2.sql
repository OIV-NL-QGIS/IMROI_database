...
DROP MATERIALIZED VIEW IF EXISTS mview_afw_binnendekking CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_bedrijfshulpverlening CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_bereikbaarheid CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_bouwlagen CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_contactpersoon CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_dreiging_bouwlaag CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_dreiging_ruimtelijk CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_gebiedsgerichte_aanpak CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_gevaarlijkestof_bouwlaag CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_gevaarlijkestof_ruimtelijk CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_grid CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_ingang_bouwlaag CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_ingang_ruimtelijk CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_isolijnen CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_label_bouwlaag CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_label_ruimtelijk CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_objectgegevens CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_opstelplaats CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_points_of_interest CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_ruimten CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_scenario_bouwlaag CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_scenario_ruimtelijk CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_schade_cirkel_bouwlaag CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_schade_cirkel_ruimtelijk CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_sectoren CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_sleutelkluis_bouwlaag CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_sleutelkluis_ruimtelijk CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_terrein CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_veiligh_bouwk CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_veiligh_install CASCADE;
DROP MATERIALIZED VIEW IF EXISTS mview_veiligh_ruimtelijk CASCADE;
