...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_afw_binnendekking;
...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_dreiging_bouwlaag;
...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_dreiging_ruimtelijk;
...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_gevaarlijkestof_bouwlaag;
...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_gevaarlijkestof_ruimtelijk;
...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_ingang_bouwlaag;
...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_ingang_ruimtelijk;
...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_opstelplaats;
...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_points_of_interest;
...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_scenario_bouwlaag;
...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_scenario_ruimtelijk;
...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_sleutelkluis_bouwlaag;
...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_sleutelkluis_ruimtelijk;
...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_veiligh_install;
...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_veiligh_ruimtelijk;
...
CREATE VIEW objecten.view_objectgegevens
...
DROP MATERIALIZED VIEW IF EXISTS objecten.mview_objectgegevens;
