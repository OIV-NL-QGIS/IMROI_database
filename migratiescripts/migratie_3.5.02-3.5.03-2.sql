...
UPDATE aanwezig SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM bouwlagen) sub WHERE aanwezig.bouwlaag_id = sub.id;
ALTER TABLE aanwezig ADD CONSTRAINT aanwezig_bouwlaag_id_fk FOREIGN KEY (bouwlaag_id, datum_deleted) REFERENCES bouwlagen (id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE afw_binnendekking SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM bouwlagen) sub WHERE afw_binnendekking.bouwlaag_id = sub.id;
UPDATE afw_binnendekking SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE afw_binnendekking.object_id = sub.id;
ALTER TABLE afw_binnendekking ADD CONSTRAINT afw_binnendekking_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE afw_binnendekking ADD CONSTRAINT afw_binnendekking_bouwlaag_id_fk FOREIGN KEY (bouwlaag_id, datum_deleted) REFERENCES bouwlagen(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE bedrijfshulpverlening SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE bedrijfshulpverlening.object_id = sub.id;
ALTER TABLE bedrijfshulpverlening ADD CONSTRAINT bedrijfshulpverlening_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE dreiging SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM bouwlagen) sub WHERE dreiging.bouwlaag_id = sub.id;
UPDATE dreiging SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE dreiging.object_id = sub.id;
ALTER TABLE dreiging ADD CONSTRAINT dreiging_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE dreiging ADD CONSTRAINT dreiging_bouwlaag_id_fk FOREIGN KEY (bouwlaag_id, datum_deleted) REFERENCES bouwlagen(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE beheersmaatregelen SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM dreiging) sub WHERE beheersmaatregelen.dreiging_id = sub.id;
ALTER TABLE beheersmaatregelen ADD CONSTRAINT beheersmaatregelen_dreiging_id_fk FOREIGN KEY (dreiging_id, datum_deleted) REFERENCES dreiging (id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE bereikbaarheid SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE bereikbaarheid.object_id = sub.id;
ALTER TABLE bereikbaarheid ADD CONSTRAINT bereikbaarheid_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE contactpersoon SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE contactpersoon.object_id = sub.id;
ALTER TABLE contactpersoon ADD CONSTRAINT contactpersoon_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE gebiedsgerichte_aanpak SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE gebiedsgerichte_aanpak.object_id = sub.id;
ALTER TABLE gebiedsgerichte_aanpak ADD CONSTRAINT gebiedsgerichte_aanpak_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE gebruiksfunctie SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE gebruiksfunctie.object_id = sub.id;
ALTER TABLE gebruiksfunctie ADD CONSTRAINT gebruiksfunctie_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE gevaarlijkestof_opslag SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM bouwlagen) sub WHERE gevaarlijkestof_opslag.bouwlaag_id = sub.id;
UPDATE gevaarlijkestof_opslag SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE gevaarlijkestof_opslag.object_id = sub.id;
ALTER TABLE gevaarlijkestof_opslag ADD CONSTRAINT gevaarlijkestof_opslag_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE gevaarlijkestof_opslag ADD CONSTRAINT gevaarlijkestof_opslag_bouwlaag_id_fk FOREIGN KEY (bouwlaag_id, datum_deleted) REFERENCES bouwlagen(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE gevaarlijkestof SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM gevaarlijkestof_opslag) sub WHERE gevaarlijkestof.opslag_id = sub.id;
ALTER TABLE gevaarlijkestof ADD CONSTRAINT gevaarlijkestof_opslag_id_fk FOREIGN KEY (opslag_id, datum_deleted) REFERENCES gevaarlijkestof_opslag (id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE gevaarlijkestof_schade_cirkel SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM gevaarlijkestof) sub WHERE gevaarlijkestof_schade_cirkel.gevaarlijkestof_id = sub.id;
ALTER TABLE gevaarlijkestof_schade_cirkel ADD CONSTRAINT schade_cirkel_gevaarlijkestof_id_fk FOREIGN KEY (gevaarlijkestof_id, datum_deleted) REFERENCES gevaarlijkestof (id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE grid SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE grid.object_id = sub.id;
ALTER TABLE grid ADD CONSTRAINT grid_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE historie SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE historie.object_id = sub.id;
ALTER TABLE historie ADD CONSTRAINT historie_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE isolijnen SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE isolijnen.object_id = sub.id;
ALTER TABLE isolijnen ADD CONSTRAINT isolijnen_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE ingang SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM bouwlagen) sub WHERE ingang.bouwlaag_id = sub.id;
UPDATE ingang SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE ingang.object_id = sub.id;
ALTER TABLE ingang ADD CONSTRAINT ingang_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE ingang ADD CONSTRAINT ingang_bouwlaag_id_fk FOREIGN KEY (bouwlaag_id, datum_deleted) REFERENCES bouwlagen(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE sleutelkluis SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM ingang) sub WHERE sleutelkluis.ingang_id = sub.id;
ALTER TABLE sleutelkluis ADD CONSTRAINT sleutelkluis_ingang_id_fk FOREIGN KEY (ingang_id, datum_deleted) REFERENCES ingang (id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE label SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM bouwlagen) sub WHERE label.bouwlaag_id = sub.id;
UPDATE label SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE label.object_id = sub.id;
ALTER TABLE label ADD CONSTRAINT label_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE label ADD CONSTRAINT label_bouwlaag_id_fk FOREIGN KEY (bouwlaag_id, datum_deleted) REFERENCES bouwlagen(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE opstelplaats SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE opstelplaats.object_id = sub.id;
ALTER TABLE opstelplaats ADD CONSTRAINT opstelplaats_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE points_of_interest SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE points_of_interest.object_id = sub.id;
ALTER TABLE points_of_interest ADD CONSTRAINT points_of_interest_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE ruimten SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM bouwlagen) sub WHERE ruimten.bouwlaag_id = sub.id;
ALTER TABLE ruimten ADD CONSTRAINT ruimten_bouwlaag_id_fk FOREIGN KEY (bouwlaag_id, datum_deleted) REFERENCES bouwlagen (id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE scenario_locatie SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM bouwlagen) sub WHERE scenario_locatie.bouwlaag_id = sub.id;
UPDATE scenario_locatie SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE scenario_locatie.object_id = sub.id;
ALTER TABLE scenario_locatie ADD CONSTRAINT scenario_locatie_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE scenario_locatie ADD CONSTRAINT scenario_locatie_bouwlaag_id_fk FOREIGN KEY (bouwlaag_id, datum_deleted) REFERENCES bouwlagen(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE scenario SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM scenario_locatie) sub WHERE scenario.scenario_locatie_id = sub.id;
ALTER TABLE scenario ADD CONSTRAINT scenario_locatie_id_fk FOREIGN KEY (scenario_locatie_id, datum_deleted) REFERENCES scenario_locatie (id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE sectoren SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE sectoren.object_id = sub.id;
ALTER TABLE sectoren ADD CONSTRAINT sectoren_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE terrein SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE terrein.object_id = sub.id;
ALTER TABLE terrein ADD CONSTRAINT terrein_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE veiligh_bouwk SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM bouwlagen) sub WHERE veiligh_bouwk.bouwlaag_id = sub.id;
ALTER TABLE veiligh_bouwk ADD CONSTRAINT veiligh_bouwk_bouwlaag_id_fk FOREIGN KEY (bouwlaag_id, datum_deleted) REFERENCES bouwlagen (id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE veiligh_install SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM bouwlagen) sub WHERE veiligh_install.bouwlaag_id = sub.id;
ALTER TABLE veiligh_install ADD CONSTRAINT veiligh_install_bouwlaag_id_fk FOREIGN KEY (bouwlaag_id, datum_deleted) REFERENCES bouwlagen (id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE veiligh_ruimtelijk SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE veiligh_ruimtelijk.object_id = sub.id;
ALTER TABLE veiligh_ruimtelijk ADD CONSTRAINT veiligh_ruimtelijk_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;

UPDATE veilighv_org SET datum_deleted = sub.datum_deleted FROM (SELECT id, datum_deleted FROM object) sub WHERE veilighv_org.object_id = sub.id;
ALTER TABLE veilighv_org ADD CONSTRAINT veilighv_org_object_id_fk FOREIGN KEY (object_id, datum_deleted) REFERENCES "object"(id, datum_deleted) ON DELETE CASCADE ON UPDATE CASCADE;
