...
ALTER TABLE beheersmaatregelen DROP CONSTRAINT beheersmaatregelen_dreiging_id_fk;
...
ALTER TABLE gevaarlijkestof_opslag DROP CONSTRAINT gevaarlijkestof_opslag_object_id_fk;
ALTER TABLE gevaarlijkestof_opslag DROP CONSTRAINT gevaarlijkestof_opslag_bouwlaag_id_fk;
...
ALTER TABLE ingang DROP CONSTRAINT ingang_bouwlaag_id_fk;
ALTER TABLE isolijnen DROP CONSTRAINT isolijnen_object_id_fk;
ALTER TABLE label DROP CONSTRAINT label_object_id_fk;
ALTER TABLE label DROP CONSTRAINT label_bouwlaag_id_fk;
